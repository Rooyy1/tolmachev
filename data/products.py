...
Поле "gc_url" — ссылка на страницу оплаты (предложение) в GetCourse для
конкретного товара. Замените плейсхолдеры на реальные ссылки из своего
аккаунта GetCourse (Продукты → нужное предложение → «Скопировать ссылку
на страницу оплаты»). Как именно эта ссылка используется — см. README.md,
раздел "Настройка GetCourse".
"""
...
PRODUCTS = {
    ...
    "split_3": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/split3",
    },
    "split_4": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/split4",
    },
    ...
    "split_3_ddx": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/split3-ddx",
    },
    "split_4_ddx": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/split4-ddx",
    },
    # ---------- Планы питания ----------
    "nutrition_mass": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/nutrition-mass",
    },
    "nutrition_cut": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/nutrition-cut",
    },
    # ---------- Тренировки + питание ----------
    "combo_mass": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/combo-mass",
    },
    "combo_cut": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/combo-cut",
    },
    # ---------- Консультации ----------
    "consult_pharma": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/consult-pharma",
    },
    "consult_plate": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/consult-plate",
    },
    "consult_complex": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/consult-complex",
    },
    # ---------- Онлайн-ведение ----------
    "online_1m": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/online-1m",
    },
    "online_3m": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/online-3m",
    },
    "online_6m": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/online-6m",
    },
    "online_12m": {
        ...
        "gc_url": "https://ВАШ_АККАУНТ.getcourse.ru/online-12m",
    },
}
